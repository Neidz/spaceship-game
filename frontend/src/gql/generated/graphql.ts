...
export type CreateSpaceshipMutation = { __typename?: 'Mutation', createSpaceship: { __typename?: 'Spaceship', id: number, name: string, crewSize: number, maxSpeed: number, range: number, cargoCapacity: number, cost: number, weight: number, batteryCapacity: number } };
...
export type RemoveSpaceshipMutation = { __typename?: 'Mutation', removeSpaceship: { __typename?: 'Spaceship', id: number, name: string, crewSize: number, maxSpeed: number, range: number, cargoCapacity: number, cost: number, weight: number, batteryCapacity: number } };
...
export type UpdateSpaceshipMutation = { __typename?: 'Mutation', updateSpaceship: { __typename?: 'Spaceship', id: number, name: string, crewSize: number, maxSpeed: number, range: number, cargoCapacity: number, cost: number, weight: number, batteryCapacity: number } };
...
export type GetSpaceshipByIdQuery = { __typename?: 'Query', spaceship: { __typename?: 'Spaceship', id: number, name: string, crewSize: number, maxSpeed: number, range: number, cargoCapacity: number, cost: number, weight: number, batteryCapacity: number } };
...
export type GetSpaceshipsQuery = { __typename?: 'Query', spaceships: Array<{ __typename?: 'Spaceship', id: number, name: string, crewSize: number, maxSpeed: number, range: number, cargoCapacity: number, cost: number, weight: number, batteryCapacity: number }> };
